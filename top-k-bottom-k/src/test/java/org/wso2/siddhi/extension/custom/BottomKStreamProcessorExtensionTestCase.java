...
public class BottomKStreamProcessorExtensionTestCase {
    ...
    @Test
    public void testBottomKStreamProcessorExtensionWithTimeBatchWindowAndJoin() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') " +
                "from inputStream1#window.timeBatch(1 sec)#custom:bottomK(item, 3) as stream1 " +
