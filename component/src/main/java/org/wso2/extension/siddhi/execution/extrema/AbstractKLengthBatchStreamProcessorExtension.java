    ...
    protected List<Attribute> init(AbstractDefinition abstractDefinition, ExpressionExecutor[] attributeExpressionExecutors,
        ...
        if (attributeExpressionExecutors.length == 3) {
            ...
            throw new ExecutionPlanValidationException("3 arguments should be passed to " +
                    getExtensionNamePrefix() + "KLengthBatchStreamProcessor, but found " + attributeExpressionExecutors.length);
        }
        ...
        if (attributeExpressionExecutors[0] instanceof VariableExpressionExecutor) {
            ...
            throw new ExecutionPlanValidationException("Attribute for ordering in " +
                    getExtensionNamePrefix() + "KLengthBatchStreamProcessor should be a variable. but found a constant attribute " +
        ...
        if (attributeExpressionExecutors[1] instanceof ConstantExpressionExecutor) {
            ...
            if (attributeType == Attribute.Type.INT) {
                ...
                throw new ExecutionPlanValidationException("Window length parameter for " +
                        getExtensionNamePrefix() + "KLengthBatchStreamProcessor should be INT. but found " + attributeType);
            }
        } else {
            throw new ExecutionPlanValidationException("Window length parameter for " +
                    getExtensionNamePrefix() + "KLengthBatchWindowProcessor should be a constant. but found a dynamic attribute " +
                    attributeExpressionExecutors[1].getClass().getCanonicalName());
        }
        ...
        if (attributeExpressionExecutors[2] instanceof ConstantExpressionExecutor) {
            ...
            if (attributeType == Attribute.Type.INT) {
                ...
                throw new ExecutionPlanValidationException("Query size parameter for " +
                        getExtensionNamePrefix() + "KLengthBatchWindowProcessor should be INT. but found " + attributeType);
            }
        } else {
            throw new ExecutionPlanValidationException("Query size parameter for " +
                    getExtensionNamePrefix() + "KLengthBatchWindowProcessor should be a constant. but found a dynamic attribute " +
